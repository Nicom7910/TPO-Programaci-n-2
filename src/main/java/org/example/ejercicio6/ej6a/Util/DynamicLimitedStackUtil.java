...
import ejercicio6.ejercicio6.ej6a.TDA.DynamicStack;

public class DynamicLimitedStackUtil extends DynamicStack {
    ...
    public DynamicLimitedStackUtil(int maxCapacity) {
